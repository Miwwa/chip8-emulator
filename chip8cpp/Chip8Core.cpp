    ...
    void Chip8Core::emulate_cycle() {
        ...
        case 0x8000:
            ...
            case 4:
                ...
                // carry does not occur
                flag = state.v[x] + state.v[y] > 255 ? 1 : 0;
                state.v[x] += state.v[y];
                state.v[0xf] = flag;
                break;
            case 5:
                // 8XY5 - Subtract the value of register VY from register VX. Set VF to 00 if a borrow occurs. Set VF to
                // 01 if a borrow does not occur
        ...
        case 0xf000:
            ...
            case 0x33:
                ...
                break;
            case 0x55:
                // FX55 Store the values of registers V0 to VX inclusive in memory starting at address I. I is set to I
                // + X + 1 after operation
                ...
                break;
            case 0x65:
                // FX65 Fill registers V0 to VX inclusive with the values stored in memory starting at address I. I is
